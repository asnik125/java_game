...
public class Football {
    public static void main(String[] args) {
        System.out.println("Let's start the game!\n " + "---You will throw the football with same speed as an NFL QB--- ");
        ...
        playChoise();
        System.out.println("Football throw distance reach "+throwCalc()+ " yards");
        System.out.println("Reciver is going for a long pass to " + longPlay() + " from line of scrimage");
        if (longPlay()< (throwCalc()-1) || longPlay() > (throwCalc()+1)){
   ...
   //compare the reciver distance with throw distance
    ...
    public static double throwCalc() {
        ...
        double calcDistance = ((22.352*22.352)*calcAngle()/9.8)*1.09361;
